...
export default function Architecture() {
  ...
  return (
    <div
      className="relative flex h-[300px] lg:h-[500px] w-full items-center justify-center overflow-hidden bg-background md:shadow-xl"
      ref={containerRef}
    >
      <div className="flex size-full flex-col max-w-[600px] max-h-[200px] items-stretch justify-between gap-10">
